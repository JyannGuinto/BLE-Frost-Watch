import { Bell, ChevronDown, Filter, Menu, Search, Sun } from 'lucide-react'
...
function Header({sidebarCollapsed, onToggleSidebar}) {
  const { user } = useAuth();
  return (
    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-b
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <p> Welcome back, {user?.username || "User"}! Here's what's happening today.</p>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            type="text"
            placeholder="Search"
            className="w-full pl-10 py-2.5 bg-slate-100 dark:bg-slate-800 border
        ...
        <div className="flex items-center space-x-3">
          ...
          dark:border-slate-700">
              <img 
                src="" 
                alt="User" 
                className="w-8 h-8 ring-blue-500"/>
              <div className="hidden md:block">
